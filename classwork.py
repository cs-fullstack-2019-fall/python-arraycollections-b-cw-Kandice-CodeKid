...
for a in reversed(numberArray): # !! : DO NOT USE A FUNCTION
    print(a)
...
def prob5(givenArray):
   for x in givenArray:
       while userInput != givenArray: # !! : this condition will never be met 
           if userArray > givenArray:
               print(len(givenArray)) # !! : this does not meet the requirement 
       else:
        print("something")
